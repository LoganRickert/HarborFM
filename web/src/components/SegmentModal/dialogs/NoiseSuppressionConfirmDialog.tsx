...
export interface NoiseSuppressionConfirmDialogProps {
  open: boolean;
...
export function NoiseSuppressionConfirmDialog({
  open,
  onOpenChange,
  onConfirm,
  loading,
}: NoiseSuppressionConfirmDialogProps) {
  return (
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className={styles.dialogDescription}>
            Apply FFT-based noise suppression to reduce background noise? This will update the audio
            file. Transcript timings are unchanged.
          </Dialog.Description>
