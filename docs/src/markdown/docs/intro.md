...
- Want the fastest path to a running instance? See [Getting Started](/docs/getting-started/).
- Prefer a detailed install guide? Start with [Docker](/docs/installation/docker/) or [Docker Compose](/docs/installation/docker-compose/).
- Already installed? Jump into [Usage: Getting started](/docs/usage/getting-started/) for first show and episode setup.
- Looking for the HTTP API? Open [API (Swagger)](/server/).
...
- [Themes](/themes/) and [Theme Authoring Guide](/theme-guide/)
