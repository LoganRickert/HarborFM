...
async function main() {
  ...
  const allSuites = [
    ...
    join(E2E_DIR, 'tests', 'Reviews', 'reviews.js'),
    join(E2E_DIR, 'tests', 'LLM', 'llm.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'subscriptions.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-permissions.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-credentials.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-plans.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-checkout.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-manage.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'stripe-coupons.js'),
    ...
    join(E2E_DIR, 'tests', 'scenarios', 'show-scheduled-episodes.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-expiration.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-files.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'subscriber-only-window.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'subscriber-only-messages.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'unlisted-sitemap.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-unlisted.js'),
    ...
    join(E2E_DIR, 'tests', 'scenarios', 'custom-domain-seo.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-polls.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-alerts.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'call-meetings.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-guest-review.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-project-zip.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'episode-archive.js'),
    ...
    join(E2E_DIR, 'tests', 'scenarios', 'multi-speaker-transcripts.js'),
    ...
    join(E2E_DIR, 'tests', 'scenarios', 'show-cast-email.js'),
    join(E2E_DIR, 'tests', 'scenarios', 'cast-profile-self-update.js'),
