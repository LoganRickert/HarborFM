  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      repo.insertPodcast({
        ...
        fundingUrl: channel.funding_url ?? null,
        fundingLabel: channel.funding_label ?? null,
        persons: channel.persons ?? null,
        updateFrequencyRrule: channel.update_frequency_rrule ?? null,
        updateFrequencyLabel: channel.update_frequency_label ?? null,
