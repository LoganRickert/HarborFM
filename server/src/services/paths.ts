...
export function episodeArtworkPath(podcastId: string, episodeId: string, ext = 'jpg'): string {
  assertSafeId(episodeId, 'episodeId');
...
export function libraryAssetPath(userId: string, assetId: string, ext = 'mp3'): string {
...
export function segmentPath(podcastId: string, episodeId: string, segmentId: string, ext = 'mp3'): string {
