...
export const settingsPatchBodySchema = z.object({
  ...
  defaultCanImportTheme: z.boolean().optional(),
  ...
  emailEventTrackingEnabled: z.boolean().optional(),
  ...
  dialInEnabled: z.boolean().optional(),
  dialInPhoneNumber: z.string().optional(),
  dialInConsentPrompt: z.string().optional(),
  /** Prefer wideband (L16 @ 16 kHz) on the Telnyx media bridge when possible. */
  dialInHdVoice: z.boolean().optional(),
  telnyxApiKey: z.string().optional(),
  /** Base64 Ed25519 public key from Telnyx Mission Control (webhook signature verify). */
  telnyxPublicKey: z.string().optional(),
...
export const settingsResponseSchema = z.object({
  ...
  defaultCanImportTheme: z.boolean(),
  ...
  emailEventTrackingEnabled: z.boolean(),
  ...
  dialInEnabled: z.boolean(),
  dialInPhoneNumber: z.string(),
  dialInConsentPrompt: z.string(),
  dialInHdVoice: z.boolean(),
  telnyxApiKey: z.string(),
  telnyxPublicKey: z.string(),
  telnyxConnectionId: z.string(),
