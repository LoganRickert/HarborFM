# Harbor FM user-data scripts

First-boot scripts to deploy a new Harbor FM instance. Use as **EC2 user-data** or **Vultr user-data** (or any cloud that supports passing a script at instance creation).
